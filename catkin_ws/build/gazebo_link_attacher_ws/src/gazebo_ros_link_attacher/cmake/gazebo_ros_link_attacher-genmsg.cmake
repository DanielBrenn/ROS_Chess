...
get_filename_component(_filename "/home/bd/Documents/GitHub/ROS_Chess/catkin_ws/src/gazebo_link_attacher_ws/src/gazebo_ros_link_attacher/srv/Attach.srv" NAME_WE)
add_custom_target(_gazebo_ros_link_attacher_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "gazebo_ros_link_attacher" "/home/bd/Documents/GitHub/ROS_Chess/catkin_ws/src/gazebo_link_attacher_ws/src/gazebo_ros_link_attacher/srv/Attach.srv" ""
)
...
_generate_srv_cpp(gazebo_ros_link_attacher
  "/home/bd/Documents/GitHub/ROS_Chess/catkin_ws/src/gazebo_link_attacher_ws/src/gazebo_ros_link_attacher/srv/Attach.srv"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/gazebo_ros_link_attacher)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/gazebo_ros_link_attacher\")")
  # install generated code
  install(
